    ...
    return (
        <div>
            <div className="mb-[2rem]">
                <h1 className="text-center text-4xl font-semibold text-[var(--primary-black)] mb-[0.5rem]">Create a post</h1>
            ...
            <form>
                ...
                <div className="flex justify-end gap-[1rem] mb-[5rem] w-full">

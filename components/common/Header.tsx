    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50">
            <div className="min-w-[var(--min-width)] max-w-[var(--max-width)] mx-auto py-[1.5rem] px-[5rem] flex items-center justify-between bg-gray-100 shadow-md">
                {/* Logo */}
                <Link href="/">
                    <Image height="40" width="120" src="/images/logo.png" alt="Logo" className="h-10 w-auto cursor-pointer" />
                </Link>
                ...
                <nav className="flex items-center space-x-8 relative">
                    <Link href="/post/all" className="text-gray-700 hover:text-black font-medium">Posts</Link>
                            ...
                            user ? (
                                <div className="flex items-center gap-[1.5rem] ml-[1rem]">
                                    ...
                                    <div className="relative">
                                        <Image
                                            src={user.avatar || "/images/images/default-avatar.png"}
                                            height={100}
                                            width={100}
                                            alt="Avatar"
                                            onClick={(e) => {
